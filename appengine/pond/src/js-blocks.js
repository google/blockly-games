...
Blockly.Blocks['controls_if'].updateShape_ = function() {
 ...
 /**
   * Atal honetan agertzen diren JSON objektu bakoitzean, bloke bat osatzeko beharrezko datuak biltzen dira, hainbat
   * aldagai erabiliz. Beste jokoetan ez bezala, JSON guztiak lista batean sartu beharrean, bloke bakoitzaren aldagaiak funtzio desberdin batean adierazten dira.
   * Aldagaien esanahiak hauek dira:
