 ...
 * @param {string} es5 Executable ES5 code (generated by Blockly or Babel).
 */
Pond.Avatar.prototype.setCode = function(blockly, js, es5) {
...
Pond.Avatar.prototype.initInterpreter = function() {
  this.interpreter = new Interpreter(this.es5, this.battle_.initInterpreter);
};
