 ...
 * @type boolean
 */
export let blocksDisabled = false;
 ...
 */
export function loadBlocks(defaultXml, inherit) {
 ...
 */
export function injectBlockly(options) {
 ...
 */
export function injectReadonly(id, xml) {
