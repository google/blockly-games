...
en: index-en puzzle-en maze-en bird-en turtle-en movie-en music-en pond-docs-en pond-tutor-en pond-duck-en
...
deps:
	...
	svn checkout https://github.com/google/blockly/branches/paternity/ $(APP_ENGINE_THIRD_PARTY)/blockly
